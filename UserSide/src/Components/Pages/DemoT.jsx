    ...
    return (
        <Container maxWidth="lg">
            <Box sx={{ py: 8 }}>
                ...
                {/* Featured Post */}
                {/* {services.filter(post => post.featured).map((post, index) => (
                ...
                <Grid container spacing={6}>
                    {services.filter(service => !service.featured).map((service, index) => (
                        <Grid item xs={12} md={4} key={index} >
                            <StyledCard spacing={6} sx={{ maxHeight: '100%' }}>
                                <CardMedia
                                    component="img"
                                ...
                                <CardContent>
                                    ...
                                    <Box sx={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                                        ...
                                        <Chip label={service.serviceType} color="gray" sx={{ mb: 2 }} />
                                    ...
                                    {/* <Typography variant="body1" color="text.secondary" align="justify">
                                        {service.expanded
                                            ...
                                            : (service.serviceDescription || '')
                                                ...
                                                .slice(0, 20)
                                                .join(' ')}
                                        {service.serviceDescription && service.serviceDescription.split('\n').length > 20 && (
                                            <span
                                                style={{
                                                    color: 'blue',
                                                    cursor: 'pointer',
                                            ...
                                            >
                                                {service.expanded ? <Button size="small">show less</Button> : <Button size="small">Read More</Button>
                                                }
                                            </span>
                                        )}
                                    </Typography> */}
                                    ...
                                    <Typography variant="body1" color="text.secondary" align="justify">
                                        {service.expanded
                                            ? service.serviceDescription
                                            : (service.serviceDescription || '')
                                                .split(' ')  // Split the description by spaces into words
                                                .slice(0, 20) // Limit to the first 20 words (adjust the number as needed)
                                                .join(' ')
                                                
                                                }  

                                        {service.serviceDescription && service.serviceDescription.split(' ').length > 20 && (
                                            <span
                                                style={{
                                                    color: 'blue',
                                                    cursor: 'pointer',
                                                ...
                                                onClick={() => toggleExpand(index)} // Toggle expanded state
                                            >
                                                {service.expanded ? (
